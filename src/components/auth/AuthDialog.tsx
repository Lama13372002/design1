              ...
              <Card className="border-none overflow-hidden shadow-xl bg-white">
                ...
                <CardContent className="space-y-6 relative z-10">
                  ...
                  <p className="text-xs text-foreground/60 text-center leading-relaxed">
                    Продолжая, вы соглашаетесь с{" "}<span className="text-blue-400 hover:text-blue-300 transition-colors cursor-pointer">условиями использования</span> и{" "}<span className="text-blue-400 hover:text-blue-300 transition-colors cursor-pointer">политикой конфиденциальности</span>
                  </p>
                </CardContent>
              </Card>
            </motion.div>
